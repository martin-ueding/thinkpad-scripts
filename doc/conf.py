...
htmlhelp_basename = 'thinkpad-scriptsdoc'
...
latex_documents = [
  ('index', 'thinkpad-scripts.tex', 'thinkpad-scripts Documentation',
...
man_pages = [
    ('man/thinkpad-dock.1', 'thinkpad-dock', 'set the screens when going to and from the docking station',
     ['Martin Ueding <mu@martin-ueding.de>'], 1),
...
texinfo_documents = [
  ('index', 'thinkpad-scripts', 'thinkpad-scripts Documentation',
   'Martin Ueding and Jim Turner', 'thinkpad-scripts', 'One line description of project.',
   'Miscellaneous'),
]
