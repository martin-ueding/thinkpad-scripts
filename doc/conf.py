...
# -*- coding: utf-8 -*-
#
# think-rotate documentation build configuration file, created by
# sphinx-quickstart on Mon Dec 16 15:18:30 2013.
#
...
htmlhelp_basename = 'think-rotatedoc'
...
latex_documents = [
  ('index', 'think-rotate.tex', 'think-rotate Documentation',
   'Martin Ueding and Jim Turner', 'manual'),
]
...
texinfo_documents = [
  ('index', 'think-rotate', 'think-rotate Documentation',
   'Martin Ueding and Jim Turner', 'think-rotate', 'One line description of project.',
   'Miscellaneous'),
]
...
rst_epilog = '''
.. |project| replace:: thinkpad-scripts
'''
