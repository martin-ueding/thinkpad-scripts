...
class PowerSources(dict):
    ...
    def __init__(self):
        ...
        for file_name in os.listdir(self.POWER_SUPPLY_SYS_BASE):
            path = os.path.join(self.POWER_SUPPLY_SYS_BASE, file_name)
...
class AcPower(PowerSource):
    ...
    @property
    def online(self): return self.read_bool('online')

class Battery(PowerSource):

    @property
    def status(self): return self.read('status')

    @property
    def present(self): return self.read_bool('present')
    ...
    @property
    def voltage_min_design(self): return self.read_int('voltage_min_design')

    @property
    def voltage_now(self): return self.read_int('voltage_now')

    @property
    def power_now(self): return self.read_int('power_now')

    @property
    def energy_full_design(self): return self.read_int('energy_full_design')

    @property
    def energy_full(self): return self.read_int('energy_full')

    @property
    def energy_now(self): return self.read_int('energy_now')

    @property
    def capacity(self): return self.read_int('capacity')
